...
- Replaced Raft state/log persistence with `AKRS2` and `AKRL4` little-endian binary formats; Raft log entries now carry per-record CRC32C for optional uncommitted-tail truncation.

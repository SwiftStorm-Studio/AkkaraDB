...
| **Kotlin**      | 2.2.21                                                                                    |
| **AkkaraDB**    | v0.2.9 (v3)                                                                               |
| **JVM Options** | `-Xmx4G -XX:+UseG1GC -XX:+AlwaysPreTouch -XX:MaxGCPauseMillis=50 z-Dfile.encoding=UTF-8"` |
...
| SST      | read-sst | 100k |      64 B |  **70,595** | **11.8** | **17.8** | **34.0** | ブロックキャッシュホット  |

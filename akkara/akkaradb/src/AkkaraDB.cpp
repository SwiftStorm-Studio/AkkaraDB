...
namespace akkaradb {
    namespace {
        ...
        [[nodiscard]] engine::vlog::VLogCodec toVLogCodec(engine::Codec codec) noexcept {
            switch (codec) {
                case engine::Codec::NONE: return engine::vlog::VLogCodec::NONE;
                case engine::Codec::ZSTD: return engine::vlog::VLogCodec::ZSTD;
            }
            return engine::vlog::VLogCodec::NONE;
        }

...
namespace akkaradb::cpu {
    namespace {
         ...
         * CRC32C, algorithm avx512_vpclmulqdq/v1e. The same generated family is
         * used by PostgreSQL's AVX-512 CRC32C path.
         */
        #define clmul_lo(a, b) (_mm512_clmulepi64_epi128((a), (b), 0x00))
        #define clmul_hi(a, b) (_mm512_clmulepi64_epi128((a), (b), 0x11))

...
if (NOT DEFINED JNI_DIST_DIR)
    set(JNI_DIST_DIR "${DIST_DIR}")
endif ()

set(DETAIL_VERSION "${DETAIL_VERSION_BASE}-${PRERELEASE}")
set(PACKAGE_NAME "akkaradb-native-${DETAIL_VERSION}-${PLATFORM}.zip")
set(PACKAGE_STAGE_DIR "${CMAKE_CURRENT_BINARY_DIR}/native-package-stage/${DETAIL_VERSION}-${PLATFORM}")
...
file(MAKE_DIRECTORY "${PACKAGE_STAGE_DIR}")
file(COPY "${DIST_DIR}/${NATIVE_LIBRARY_NAME}" DESTINATION "${PACKAGE_STAGE_DIR}")
file(COPY "${JNI_DIST_DIR}/${JNI_LIBRARY_NAME}" DESTINATION "${PACKAGE_STAGE_DIR}")
